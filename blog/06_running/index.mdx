...
export const meta = {
  ...
  description:
    'Why should you run? An article on why and how I got started with running and how it evolved over the past years.',
  categories: [config.blog.categories.general],
  images: {
    teaser: {
      sizes: '100vw',
      src: require('./images/running-1000.png'),
    ...
    laydown: {
      sizes: '100vw',
      src: require('./images/raceday-laydown-1000.png'),
    ...
    statistics: {
      sizes: '100vw',
      src: require('./images/running-statistics-1000.png'),
    ...
    medal: {
      sizes: '100vw',
      src: require('./images/marathon-medal-1000.png'),
...
<Updated in="April 2015">
  … and yes, I did pass the finish line :) <img {...meta.images.medal} />
</Updated>
