export const meta = {
  ...
  description:
    'Introducing Runverter.io, the only running calculator you will ever need. Featuring a pace calculator, race predictor, split time calculator and much more.',
  categories: ['runverter'],
  images: {
    teaser: {
      sizes: '100vw',
      width: '90%',
      src: require('./images/runverter-logo-1000.png'),
    ...
    design: {
      sizes: '100vw',
      src: require('./images/runverter-design-1000.gif'),
    ...
    suggestions: {
      sizes: '100vw',
      width: '90%',
      src: require('./images/smart-suggestions-1000.gif'),
    ...
    shortcuts: {
      sizes: '100vw',
      width: '90%',
      src: require('./images/keyboard-controls-1000.gif'),
    ...
    expert: {
      sizes: '100vw',
      src: require('./images/expert-mode-1000.gif'),
    ...
    decimals: {
      sizes: '100vw',
      src: require('./images/detailed-decimal-place-1000.gif'),
    ...
    input: {
      sizes: '100vw',
      src: require('./images/cross-tool-input-fields-1000.gif'),
    ...
    offline: {
      sizes: '100vw',
      src: require('./images/offline-support-1000.gif'),
