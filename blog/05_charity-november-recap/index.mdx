export const meta = {
  ...
  images: {
    teaser: {
      sizes: '100vw',
      src: require('./images/charity-november-recab-600.png'),
    ...
    letter: {
      sizes: '100vw',
      src: require('./images/charity-november-thank-you-letter-600.png'),
...
Last month was very exciting. I decided to [donate all of november's Stickerlicious income](http://stefankracht.de/news/give-something-back) and the feedback was overwhelming. I received lots of great feedback and many people startet to share this campaign.
