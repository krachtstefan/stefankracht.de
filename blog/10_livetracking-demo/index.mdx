...
export const meta = {
  id: 10,
  title: 'Race day live tracking for runners',
  url: 'raceday-livetracking-for-runners',
  date: new Date('2018-01-14T00:00:00'),
  description:
    'The first draft of an idea about race day live tracking for runners that became my side project raceday.me.',
  categories: ['raceday'],
  images: {
    teaser: {
      sizes: '100vw',
      src: require('./images/raceday-livetracking-demo-1000.png'),
...
<Updated in="January 2019">
  It's been a while since this post and I finally released{' '}
...
I call myself a [runner](running) and I do races pretty regularly. When you're into running, race day is a very special event as it mostly involves a longer period of focused preparation that all goes down to nail this special day.
...
If you're unsatisfied with something you have basically two options. Deal with it or do something about it. I'm a developer and this time I chose the second option (I did that [before](runverter) btw). Please watch this video to get an idea of what I've been working on for the last couple of months.

<YouTube videoId={'2_iesCS96FE'} className="youtube" />

## Any Feedback?

This is still an early prototype but I'm very curious about any feedback. What do you think about it? Tell me your thoughts on [twitter](https://twitter.com/stefan_kracht).
