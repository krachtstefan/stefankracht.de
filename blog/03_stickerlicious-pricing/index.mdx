...
export const meta = {
  ...
  description:
    'All income and expenses of my online sticker shop Stickerlicious and why I charge 8 € for a sticker.',
  categories: [config.blog.categories.stickerlicious],
  images: {
    teaser: {
      sizes: '100vw',
      src: require('./images/macbook-sticker-shipping-1000.png'),
      srcSet: `${require('./images/macbook-sticker-shipping-600.png')} 600w, ${require('./images/macbook-sticker-shipping-1000.png')} 1000w, ${require('./images/macbook-sticker-shipping-1800.png')} 1800w`,
      alt: 'A macbook with a stickerlicious sticker on it'
    },
    allocation: {
      sizes: '100vw',
      src: require('./images/macbook-sticker-price-allocation-1000.png'),
      srcSet: `${require('./images/macbook-sticker-price-allocation-600.png')} 600w, ${require('./images/macbook-sticker-price-allocation-1000.png')} 1000w, ${require('./images/macbook-sticker-price-allocation-1800.png')} 1800w`,
      alt:
    ...
    shipping: {
      ...
      src: require('./images/macbook-sticker-shipping-1000.png'),
      srcSet: `${require('./images/macbook-sticker-shipping-600.png')} 600w, ${require('./images/macbook-sticker-shipping-1000.png')} 1000w, ${require('./images/macbook-sticker-shipping-1800.png')} 1800w`,
      alt: 'A desk full of stickers and packaging material'
    }
  }
};

It's been a while now since I've launched my MacBook sticker shop [stickerlicio.us](http://stickerlicio.us). Over the last couple of years I've shipped a lot of orders from all around the world, have been featured by some awesome websites and received overwhelming feedback from many of my customers.
...
<img {...meta.images.shipping} />

In addition to the everyday work, I try my best to keep a close relationship to my customers. Doing some social media work, answering support questions, sending replacement stickers if one got broken. I even decided to [open source all of my sticker designs](https://github.com/krachtstefan/stickerlicious-templates) so you're able to reproduce or recreate all of my stickers if you are out of money or have great ideas for your own sticker design.
