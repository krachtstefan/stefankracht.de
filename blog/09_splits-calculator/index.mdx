...
export const meta = {
  ...
  description:
    'Runverter.io now supports a splits calculator that displays the perfect split times you need to finish a race in your desired time.',
  categories: [config.blog.categories.runverter],
  images: {
    teaser: {
      sizes: '100vw',
      src: require('./images/splits-calculator-screenshot-1000.png'),
    ...
    screenrecording: {
      sizes: '100vw',
      src: require('./images/splits-calculator-detail-1000.gif'),
    ...
    progress: {
      sizes: '100vw',
      src: require('./images/splits-progress-1000.gif'),
    ...
    print: {
      sizes: '100vw',
      src: require('./images/print-splits-1000.gif'),
