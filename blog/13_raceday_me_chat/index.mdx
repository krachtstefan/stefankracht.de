...
To explain the idea behind it, let me give you an idea of various scenarios that I consider as useful.
...
The special fun starts when some spectators are on sight and share some exclusive information. That could be anything like weather conditions, photos from the cheer zone or just their location to inform the athlete about where to expect a little motivational boost
...
The athlete might use the chat to post pictures before the race or inform the viewers with a short race recap from the finish area. Or remember an ultra race where the runner might need some supporting words during a walking pause. It‘s also pretty handy if something unexpected happens, like a DNF or an injury (post location!!)
