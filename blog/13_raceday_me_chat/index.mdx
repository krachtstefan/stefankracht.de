...
To enhance the chat even more, the racebot will inform you about various type of events to give you a more accessible way to follow the race and put other messages into context.

<img {...meta.images.chatbot} />

Racebot has various type of skills, here is a small overview of what it can do for you:

- provides a small briefing before the race begins
- informs when the app was started or stopped
- posts a message when the athlete starts the race or crosses the finish line
- detects when the athlete went off course or took a break
...
- Gives post race information like f.e. the link to the official race results
