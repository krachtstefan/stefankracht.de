export const meta = {
  ...
  images: {
    teaser: {
      sizes: '100vw',
      src: require('./images/3d-models-with-ruby-600.png'),
    ...
    sampleFront: {
      sizes: '100vw',
      src: require('./images/example-3d-project-front-600.png'),
    ...
    sampleSide: {
      sizes: '100vw',
      src: require('./images/example-3d-project-side-600.png'),
    ...
    sampleTop: {
      sizes: '100vw',
      src: require('./images/example-3d-project-top-600.png'),
...
The [Wavefront .obj file](http://en.wikipedia.org/wiki/Wavefront_.obj_file) won with a fairly good compatibility in the 3D online printing market: it's supported by common 3D modeling software and it even opens in Photoshop (tested with CS5).
...
<iframe
  height="360"
  width="100%"
  src="http://skfb.ly/m3g2e1cba?autostart=0&transparent=0&autospin=0&controls=1"
/>
...
<iframe
  height="360"
  width="100%"
  src="http://skfb.ly/m3h2fed?autostart=0&transparent=0&autospin=0&controls=1"
/>
